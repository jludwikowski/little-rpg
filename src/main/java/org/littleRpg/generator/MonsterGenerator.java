...
public class MonsterGenerator extends Generator<Monster> {
    ...
    private Monster getMonster(MonsterTypes[] monsterTypesArray){
        ...
        baseMonster.monsterLevel = random.nextInt(8);
        ...
        switch(monsterType) {
            case goblin:
                return new Monster(monsterType, name, "green goblin",5,5, 0,
                        ...
                        null, 0, null, 0,0, new Archetype(1,0,
                        1,1,1));
            case slime:
                return new Monster(monsterType, name, "foul smelling gelatinous mass",20,20,0,
                        0,15,1,0, null, null,
                        itemGenerator.getEntities(30), null, 0, null, 0,0,
                        new Archetype(1,0, 0,2,0));
            case elf:
                return new Monster(monsterType, name, "elf",20,20,0,
                        ...
                        null,0, null,0,0, new Archetype(3,2,
                        1,1,1));
            case human:
                return new Monster(monsterType, name, "human",20,20,0,0,
                        ...
                        null,0, null,0,0, new Archetype(2,1,
                        2,1,2));
            case orc:
            ...
            case ogr:
                return new Monster(monsterType, name, "ogr",30,30,0,0,
                        ...
                        null,0, null,0,0,new Archetype(3,0,
                        3,3,1));
            case giant:
